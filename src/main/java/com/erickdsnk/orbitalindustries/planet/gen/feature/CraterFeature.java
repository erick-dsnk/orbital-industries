...
/**
 * Terrain feature that carves bowl-shaped craters with an ejecta rim. Options:
 * craterChancePerChunk, minRadius, maxRadius, minDepth, maxDepth, rimHeight.
...
public final class CraterFeature implements TerrainFeature {
    ...
    public void apply(Chunk chunk, int chunkX, int chunkZ, int baseWorldX, int baseWorldZ,
        ...
        applyCratersToChunk(chunk, context, baseWorldX, baseWorldZ, craters, topSurfaceY, rimHeight);
    }
    ...
    private void applyCratersToChunk(Chunk chunk, TerrainFeatureContext context, int baseWorldX, int baseWorldZ,
            List<Crater> craters, int[][] topSurfaceY, int rimHeight) {
