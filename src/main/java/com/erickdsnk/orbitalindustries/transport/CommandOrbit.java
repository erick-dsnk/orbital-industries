...
/**
 * Debug command /orbit: teleports the commanding player to the orbit dimension.
 * Uses TeleportManager and PositionUtils for safe spawn. Later will support
 * planets, moons, and orbital stations as targets.
 */
public class CommandOrbit extends CommandBase {

    private static final OIModLogger LOG = new OIModLogger("CommandOrbit");
    ...
    public void processCommand(ICommandSender sender, String[] args) {
        ...
        int dimensionId = ConfigManager.getOrbitDimensionId();
        ...
        LOG.info("Player " + player.getCommandSenderName() + " teleported to orbit dimension");
    }
