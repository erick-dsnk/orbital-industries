...
/**
 * Default AtmosphereManager: looks up planet by dimension ID and returns hasAtmosphere.
 *
 * TODO: Space dimension (no planet) = no atmosphere. Overworld = breathable when not in space.
 */
public final class AtmosphereManagerImpl implements AtmosphereManager {
    ...
    public boolean hasAtmosphere(int dimensionId) {
        ...
        return planet != null && planet.hasAtmosphere();
    }
